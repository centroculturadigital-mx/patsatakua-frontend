...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			img0 = claim_element(ul1_nodes, "IMG", { src: true, alt: true, class: true }, false);
			var img0_nodes = children(img0);

			img0_nodes.forEach(detach_dev);
			t18 = claim_space(ul1_nodes);

			img1 = claim_element(ul1_nodes, "IMG", { src: true, alt: true, class: true }, false);
			var img1_nodes = children(img1);

			img1_nodes.forEach(detach_dev);
			t19 = claim_space(ul1_nodes);

			img2 = claim_element(ul1_nodes, "IMG", { src: true, alt: true, class: true }, false);
		...
		h: function hydrate() {
			...
			attr_dev(h1, "class", "Titulo svelte-19t7f1c");
			add_location(h1, file, 133, 3, 1900);
			attr_dev(h4, "class", "Subtitulo svelte-19t7f1c");
			add_location(h4, file, 137, 3, 1952);
			add_location(header, file, 132, 2, 1887);
			add_location(p0, file, 144, 3, 2109);
			add_location(p1, file, 147, 3, 2362);
			attr_dev(section0, "class", "Introduccion svelte-19t7f1c");
			add_location(section0, file, 143, 2, 2074);
			attr_dev(div0, "class", "Lateral svelte-19t7f1c");
			add_location(div0, file, 131, 1, 1862);
			attr_dev(ul0, "class", "svelte-19t7f1c");
			add_location(ul0, file, 158, 3, 2802);
			attr_dev(section1, "class", "Lista svelte-19t7f1c");
			add_location(section1, file, 157, 2, 2774);
			add_location(br0, file, 176, 0, 3352);
			add_location(br1, file, 177, 0, 3358);
			attr_dev(section2, "class", "TextoPie svelte-19t7f1c");
			add_location(section2, file, 170, 3, 3011);
			attr_dev(img0, "src", "https://source.unsplash.com/user/erondu/140x70");
			attr_dev(img0, "alt", "");
			attr_dev(img0, "class", "svelte-19t7f1c");
			add_location(img0, file, 185, 3, 3634);
			attr_dev(img1, "src", "https://source.unsplash.com/user/erondu/140x70");
			attr_dev(img1, "alt", "");
			attr_dev(img1, "class", "svelte-19t7f1c");
			add_location(img1, file, 186, 3, 3704);
			attr_dev(img2, "src", "https://source.unsplash.com/user/erondu/140x70");
			attr_dev(img2, "alt", "");
			attr_dev(img2, "class", "svelte-19t7f1c");
			add_location(img2, file, 187, 3, 3774);
			add_location(ul1, file, 184, 3, 3625);
			attr_dev(section3, "class", "LogosPie svelte-19t7f1c");
			add_location(section3, file, 183, 3, 3594);
			attr_dev(footer, "class", "Pie svelte-19t7f1c");
			add_location(footer, file, 169, 1, 2986);
			attr_dev(div1, "class", "contenedor-principal svelte-19t7f1c");
			add_location(div1, file, 156, 1, 2736);
			attr_dev(section4, "class", "Inicio svelte-19t7f1c");
			add_location(section4, file, 129, 0, 1833);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
